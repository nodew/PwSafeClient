...
internal sealed class UpdatePolicyCommand : AsyncCommand<UpdatePolicyCommand.Settings>
{
    ...
    public UpdatePolicyCommand(IDocumentService documentService)
    {
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        try
        {
            ...
            policy.TotalPasswordLength = settings.Length;
            ...
            AnsiConsole.MarkupLine($"[green]Password policy '{policy.Name}' was updated successfully[/]");
            return 0;
        }
        catch (Exception ex)
        {
